...
def binary_load(fp, mapper=dict, merge_duplicate_keys=True, alt_format=False, raise_on_remaining=False, unsigned=True):
    """
...
def _binary_dump_gen(obj, level=0, alt_format=False, unsigned=True):
